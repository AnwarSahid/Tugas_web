...
<div class="row no-gutters mt-4 ">
    ...
    <div class="col-md-10 mt-2 p-5 pl-5">
        <h3><i class="fas fa-coins mr-2"></i>  REKAP DANA DESA </h3> <hr class="bg-secondary">
        <a class="btn btn-info mb-3 text-bold" href="/danaswadaya" role="button">SWADAYA MASAYARAKAT<i class="fas fa-angle-double-right ml-2"></i></a>

        <a class="btn btn-success mb-3 text-bold" href="/danadesa/tambahrincian" role="button">TAMBAH RINCIAN<i class="fas fa-plus ml-2"></i></></a>
        ...
        <table class="table table-striped">
                ...
                <?php $__currentLoopData = $danadesa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <th scope="row"><?php echo e($loop->iteration); ?></th>
                        <td><?php echo e($dd-> tanggal); ?></td>
                        <td><?php echo e($dd-> pemasukan); ?></td>
                        <td><?php echo e($dd-> sumber); ?></td>
                        <td><?php echo e($dd-> pengeluaran); ?></td>
                        <td><?php echo e($dd-> penggunaan); ?></td>
                        <td><?php echo e($dd-> total); ?></td>
                        <td>
                            <div class="row ">
                                    
                    
                                    <a href="/danadesa/hapus/<?php echo e($dd->id); ?>" class="badge badge-danger btn-sm ml-2"> Delete</a>
                            </div>
                        </td>
...
</html><?php /**PATH E:\TUGAS UNILA\SEMESTER 5\web\tugasweb\desaku\resources\views/dana.blade.php ENDPATH**/ ?>