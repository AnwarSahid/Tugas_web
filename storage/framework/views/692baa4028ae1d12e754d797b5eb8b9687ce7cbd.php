...
<div class="row no-gutters mt-4 ">
    ...
    <div class="col-md-10 mt-2 p-5 pl-5">
        <h3><i class="fas fa-user-plus mr-2"></i>  FORM TAMBAH RINCIAN </h3> <hr class="bg-secondary">
            ...
            <form method="post" action="/danaswadaya/tambahrincian">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="tanggal" aria-describedby="tanggalhelp" name="tanggal" value="<?php echo e(old('tanggal')); ?>">
...
<?php /**PATH E:\TUGAS UNILA\SEMESTER 5\web\tugasweb\desaku\resources\views/tambahrincian2.blade.php ENDPATH**/ ?>